...
struct NTSolar {
	      ...
	      calendar: Calendar = Calendar(identifier: .gregorian))
	{
		...
		sunrise = NTSolar.dateFromUTCHours(sunriseSet.trise,
		                                   year: year,
		                                   month: month,
		                                   day: day,
		                                   calendar: calendar,
		...
		sunset = NTSolar.dateFromUTCHours(sunriseSet.tset,
		                                  year: year,
		                                  month: month,
		                                  day: day,
		                                  calendar: calendar,
		...
		civilSunrise = NTSolar.dateFromUTCHours(civil.trise,
		                                        year: year,
		                                        month: month,
		                                        day: day,
		                                        calendar: calendar,
		...
		civilSunset = NTSolar.dateFromUTCHours(civil.tset,
		                                       year: year,
		                                       month: month,
		                                       day: day,
		                                       calendar: calendar,
		...
		nauticalSunrise = NTSolar.dateFromUTCHours(nautical.trise,
		                                           year: year,
		                                           month: month,
		                                           day: day,
		                                           calendar: calendar,
		...
		nauticalSunset = NTSolar.dateFromUTCHours(nautical.tset,
		                                          year: year,
		                                          month: month,
		                                          day: day,
		                                          calendar: calendar,
		...
		astronomicalSunrise = NTSolar.dateFromUTCHours(astronomical.trise,
		                                               year: year,
		                                               month: month,
		                                               day: day,
		                                               calendar: calendar,
		...
		astronomicalSunset = NTSolar.dateFromUTCHours(astronomical.tset,
		                                              year: year,
		                                              month: month,
		                                              day: day,
		                                              calendar: calendar,
		...
		solarNoon = NTSolar.dateFromUTCHours(solarNoonUTC,
		                                     year: year,
		                                     month: month,
		                                     day: day,
		                                     calendar: calendar,
	...
	private static func sind(x: Double) -> Double {
		return sin(x * DEGRAD)
	}

	private static func cosd(x: Double) -> Double {
		return cos(x * DEGRAD)
	}

	private static func tand(x: Double) -> Double {
		return tan(x * DEGRAD)
	}

	private static func atand(x: Double) -> Double {
		return RADEG * atan(x)
	}

	private static func asind(x: Double) -> Double {
		return RADEG * asin(x)
	}

	private static func acosd(x: Double) -> Double {
		return RADEG * acos(x)
	}

	private static func atan2d(y: Double, x: Double) -> Double {
	                             ...
	                             upper_limb: Int) -> (trise: Double, tset: Double, code: ReturnCode)
	{
		...
		var rc = ReturnCode.RiseAndSet /* Return cde from function - usually 0 */
