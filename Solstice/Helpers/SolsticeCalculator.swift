...
enum SolsticeCalculator {
	...
	private static let mc0 = [1_721_139.29189, 365_242.13740, 0.06134, 0.00111, -0.00071],
	                   jc0 = [1_721_233.25401, 365_241.72562, -0.05232, 0.00907, 0.00025],
	                   sc0 = [1_721_325.70455, 365_242.49558, -0.11677, -0.00297, 0.00074],
	                   dc0 = [1_721_414.39987, 365_242.88257, -0.00769, -0.00933, -0.00006],

	                   mc2 = [2_451_623.80984, 365_242.37404, 0.05169, -0.00411, -0.00057],
	                   jc2 = [2_451_716.56767, 365_241.62603, 0.00325, 0.00888, -0.00030],
	                   sc2 = [2_451_810.21715, 365_242.01767, -0.11575, 0.00337, 0.00078],
	                   dc2 = [2_451_900.05952, 365_242.74049, -0.06223, -0.00823, 0.00032]

	private static let J2000 = 2_451_545.0
	private static let julianCentury = 36525.0
	...
	private static func dateFromJd(jd: Double) -> Date {
		let JD_JAN_1_1970_0000GMT = 2_440_587.5
...
extension Date {
	var recentSolstices: [Date] {
		let year = solarCalendar.component(.year, from: self)
